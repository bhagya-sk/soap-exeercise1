...
public class StockTradeDaoMysqlImpl implements IStockTradeDao {
	...
	public List<StockTrade> getStockTradeRecords()
		...
		try {
			...
			throw new DBAccessFailureDaoException("unable to access stockTrade record with close= "+stockObj.getClose() , exp);
		} finally {
	...
	public void createStockTradeRecord(StockTrade stockTradeObj)
		...
		try {
			...
			LOGGER_OBJ.error("unable to access stocktrade database");
			throw new DBAccessFailureDaoException("unable to insert stockTrade record with close= "+stockTradeObj.getClose() , exp);
		} finally {
	...
	public void deleteStockTradeRecord(int stockTradeId)
		...
		try {
			...
			LOGGER_OBJ.error("unable to access stocktrade database");
			throw new DBAccessFailureDaoException("unable to delete stocktrade  with id= "+ stockTradeId, exp);
		} finally {
	...
	public void updateStockTradeRecord(int stockTrdId, double volume)
		...
		try {
			...
			LOGGER_OBJ.error("unable to access stocktrade database");
			throw new DBAccessFailureDaoException("unable to update stocktrade record with stockTrd id= " +stockTrdId, exp);
		} finally {
